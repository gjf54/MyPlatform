...
<div class="header">
    ...
    <div class="header_text">
        ...
        <a href="{{ route('catalog') }}" class="col-sm-12 col-md-2 btn btn-primary btn-lg active" aria-disabled="true" role="button">Открытый код на GitHub</a> 
    </div>
</div>
